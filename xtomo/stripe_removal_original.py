...
# cupyx.scipy.ndimage.median_filter
# binary_dilation: use cupyx.scipy.ndimage.grey_dilation
# scipy.interpolate.interp2
# cupy.fft ... import pyfftw.interfaces.scipy_fftpack as fft
...
def binary_dilation1(list_mask,iterations=1):
    output = grey_dilation(list_mask, iterations+1)
    #output = np.asarray(output>.5,dtype=output.dtype)
    return output
