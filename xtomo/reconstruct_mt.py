...
#            return np.swapaxes(tomo_t,0,1), rnrm, 0.
    ...
    def read_data(ii):
        ...
        if even==1:
            ...
            #print('reading even',ii,flush=True)
            data_even = sino[chunks[0]:chunks[1],...]
            done[0] = 1
            ...
            #print('read odd',ii, 'done[1] set to:', done[1])
...
#            while True:
                ...
                #printv('waiting for data even',ii)
                #time.sleep(.001)
            data = data_even #sino[chunks[0]:chunks[1],...]
        else:
            #jj=0
            while done[1]==0:
