...
print('receiving sino by mpi_worker',rank)
    
sino_shape = comm_intra.bcast(sino_shape,root=0)    
print('received sino by mpi_worker',rank)
...
from xtomo.spawn import mmdata as mmdata

shared_sino = mmdata(sino_shape, 'data', mode='r')
#    print('allocated shared')
shared_theta = mmdata(theta_shape, 'theta', mode = 'r')   
shared_tomo =mmdata(tomo_shape, 'tomo', mode='r+')
